...
Firmware chạy model TinyCNN V8 full INT8 cục bộ để phân loại `paper`, `plastic`
...
1. Mở `ESP-TRASH-V2.ino` bằng Arduino IDE.
...
- Model nguồn: `AI/V8/artifacts/model_int8.tflite`, 62,560 byte, SHA-256
...
- QVGA RGB565 -> center crop -> nearest-neighbor floor 96 x 96 -> gray-world
  ...
  `[192,341]` -> quantize. Đây là đúng thứ tự preprocessing V8 lúc train.
