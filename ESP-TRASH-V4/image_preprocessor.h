...
// Resizes the complete interleaved RGB frame to 128x96 with a deterministic
// nearest-neighbor mapping (no square or aspect-ratio crop),
// simulates RGB565 truncation, applies bounded gray-world white balance and
// mean-luminance normalization, then writes quantized values directly into
// the TFLM input tensor. Sampling offsets are cached and no heap allocation
// occurs.
