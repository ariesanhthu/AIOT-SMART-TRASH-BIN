"""ESP32-sized V9 classifier using only TFLite Micro friendly operators."""

import tensorflow as tf

from V9.config import CLASS_NAMES, IMAGE_CHANNELS, IMAGE_SIZE


def build_model(dropout: float = 0.18) -> tf.keras.Model:
    ...
    return tf.keras.Model(inputs, outputs, name="tinycnn_v9_balanced_esp_contract")
