"""Evaluate V9 float and quantized models on the exact same held-out images."""
...
from V9.config import ARTIFACTS_DIR, CLASS_NAMES, DATASET_DIR
...
def main() -> None:
    ...
    report = {
        ...
        "preprocessing": "V9 deterministic ESP-TRASH-V2 contract for both models",
